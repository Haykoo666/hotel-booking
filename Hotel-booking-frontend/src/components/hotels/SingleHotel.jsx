        ...
        <Container className="m-4 ">
          ...
          <Row>
            ...
            <Col md={6}>
              ...
              <p>
                {/* <GoLocation /> */}
                <img src="/img/location.png" alt="location icon" width={ 24 } className='mr-10'/>

                {hotel.location}
              </p>
              <p>
                {/* <BiCalendarAlt /> */}
                <img src="/img/calendar.png" alt="calendar icon" width={ 24 } height={ 24 } className='mr-10'/>
              ...
              <p>
                {/* <BiBed /> */}
                <img src="/img/bed-icon.png" alt="calendar icon" width={ 24 } height={ 24 } className='mr-10'/>
