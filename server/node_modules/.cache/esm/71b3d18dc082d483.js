let Hotel,Order,fs;_c08‍.x([["create",()=>create],["hotels",()=>hotels],["image",()=>image],["sellerHotels",()=>sellerHotels],["remove",()=>remove],["read",()=>read],["update",()=>update],["userHotelBookings",()=>userHotelBookings],["isAlreadyBooked",()=>isAlreadyBooked],["searchListings",()=>searchListings]]);_c08‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_c08‍.w("../models/order",[["default",["Order"],function(v){Order=v}]]);_c08‍.w("fs",[["default",["fs"],function(v){fs=v}]]);
  ...
  try {
    ...
    hotel.save((err, result) => {
      if (err) {
        _c08‍.g.console.log("saving hotel err => ", err);
        res.status(400).send("Error saving");
      }
      res.json(result);
    });
  } catch (err) {
    _c08‍.g.console.log(err);
    res.status(400).json({
      err: err.message,
    });
  }
